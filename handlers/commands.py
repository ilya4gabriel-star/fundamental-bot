...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "_Example: /variance BTC_\n"
        "_Example: /variance BTC ETH SOL — compare_\n\n"
        "💼 *Paper Trading*\n"
        "/balance — your virtual portfolio\n"
        "/buy `<ticker>` `<amount>` — buy asset\n"
        "_Example: /buy BTC 500_\n\n"
        "/sell `<ticker>` `<amount>` — sell asset\n"
        "_Example: /sell BTC 200_\n\n"
        "/positions — open positions with P&L\n"
        "/history — last 10 trades\n"
        "/reset — reset account to $10,000\n\n"
        "📚 *Education*\n"
